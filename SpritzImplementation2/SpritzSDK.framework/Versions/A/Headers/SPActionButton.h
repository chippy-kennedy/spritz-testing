...
/**
 SPActionButon class lets you create custom buttons and actions for the SPControlView. By creating an SPActionButton and adding it to an SPControlView, additional buttons when the user selects 'Settings' on the SPControlView.
 */
