...
/**
 SPControlView is a subclass of the SPBaseView that implements simple UI controls instead of requiring developers to implement their own controls. If a user taps on the SPControlView, the SPControlView control automatically pauses the current text stream and provides buttons to rewind, go back a sentence, resume, and change settings.
 */
